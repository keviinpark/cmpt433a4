...
int main(void)
{
	...
	while (true) {
		color[0] = getSharedMem_uint32(BASE, C0_OFFSET + 0 * sizeof(uint32_t));
		color[1] = getSharedMem_uint32(BASE, C0_OFFSET + 1 * sizeof(uint32_t));
		color[2] = getSharedMem_uint32(BASE, C0_OFFSET + 2 * sizeof(uint32_t));
		color[3] = getSharedMem_uint32(BASE, C0_OFFSET + 3 * sizeof(uint32_t));
		color[4] = getSharedMem_uint32(BASE, C0_OFFSET + 4 * sizeof(uint32_t));
		color[5] = getSharedMem_uint32(BASE, C0_OFFSET + 5 * sizeof(uint32_t));
		color[6] = getSharedMem_uint32(BASE, C0_OFFSET + 6 * sizeof(uint32_t));
		color[7] = getSharedMem_uint32(BASE, C0_OFFSET + 7 * sizeof(uint32_t));
